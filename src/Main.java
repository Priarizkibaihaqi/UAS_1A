        ...
        while (true) {
            ...
            if (kapasitasMesin >= 1000 && kapasitasMesin <= 1200) {
                if (kapasitasLantai3 >= 0) {
                    ...
                    System.out.println("Maaf, lantai three penuh.");
                }
                ...
                if (kapasitasLantai2 >= 0) {
                    ...
                    System.out.println("Maaf, lantai two penuh.");
                }
                ...
                if (kapasitasLantai1 >= 0) {
                    ...
                    System.out.println("Maaf, lantai one penuh.");
                }
            } else {
                System.out.println("Kendaraan tidak memenuhi kriteria.");
            }

            System.out.println("Jumlah Kendaraan di Lantai one: " + mobilCountLantai1);
            System.out.println("Jumlah Kendaraan di Lantai two: " + mobilCountLantai2);
            System.out.println("Jumlah Kendaraan di Lantai thre: " + mobilCountLantai3);
        }
    }
}